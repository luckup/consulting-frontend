export const enIndustries = {
  ...
  ecommerce: {
    ...
    ctaLabel: 'Discuss commerce solutions',
  },
  logistics: {
    label: 'Logistics',
  ...
  healthcare: {
    ...
    ctaLabel: 'Explore healthcare delivery',
  },
  construction: {
    label: 'Construction',
    ...
    ctaLabel: 'Discuss construction software',
  },
  manufacturing: {
    label: 'Manufacturing',
    ...
    ctaLabel: 'Discuss manufacturing programs',
  },
  education: {
    label: 'Education',
  ...
  agriculture: {
    ...
    ctaLabel: 'Discuss agriculture programs',
  },
  restaurant: {
    ...
    ctaLabel: 'Discuss hospitality solutions',
  },
} as const
